...
public class IOPanel extends JPanel
{
	...
	private void setupLayout()
	{
		...
		baseLayout.putConstraint(SpringLayout.WEST, rankingField, 35, SpringLayout.EAST, rankingLabel);
		baseLayout.putConstraint(SpringLayout.NORTH, rulesLabel, 23, SpringLayout.SOUTH, rankingLabel);
		...
		baseLayout.putConstraint(SpringLayout.SOUTH, titleField, -6, SpringLayout.NORTH, rankingField);
		...
		baseLayout.putConstraint(SpringLayout.EAST, saveButton, 0, SpringLayout.EAST, gameCountLabel);
		baseLayout.putConstraint(SpringLayout.WEST, gameCountLabel, 68, SpringLayout.WEST, this);
		baseLayout.putConstraint(SpringLayout.SOUTH, gameCountLabel, -271, SpringLayout.SOUTH, this);
	...
	private void setupListeners()
	{
		...
		saveButton.addActionListener(new ActionListener()
		{
			...
			{
				Game tempGame = baseController.makeGameFromInput(titleField.getText(), rankingField.getText(),
						rulesArea.getText());
				if (tempGame != null)
				{
					baseController.saveGameInformation(tempGame);
					gameCountLabel.setText("Number of Games: " + baseController.getProjectGames().size());
				}
				else
				{
		...
		loadButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent click)
			{
				...
				{
					JOptionPane.showMessageDialog(null, "Check the file, make sure it is in order.");
				}
